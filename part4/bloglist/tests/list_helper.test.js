...
describe('TESTING: favoriteBlog function', () => {
  ...
  test('when list has more than one blog, return the blog with the highest likes', () => {
  ...
  test('when list has more than one blog with at least two blogs who has the same highest likes', () => {
    ...
    const result = listHelper.favoriteBlog(blogsTwoHighestLikes)
...
describe('TESTING: mostBlogs function', () => {
  ...
  test('when list has more than one blog, return the author with the highest number of blogs ', () => {
  ...
  test('when list has more than one blog with at least two authors who has the same highest number of blogs', () => {
    ...
    const result = listHelper.mostBlogs(blogsTwoMostAuthored)
    assert.deepStrictEqual(result,answer)
  })
